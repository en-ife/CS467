...
public protocol ZeitSatTrackManagerDelegate : AnyObject {
...
open class ZeitSatTrackManager: NSObject, CLLocationManagerDelegate {
    ...
    @objc func positionsForObservedSatellites() {
    ...
    func startUpdateTimer() {
        self.updateTimer = Timer.scheduledTimer(timeInterval: updateInterval, target: self, selector: #selector(positionsForObservedSatellites), userInfo: nil, repeats: true)
    }
